...
class ThreeLayerConvNet(object):
    ...
    def loss(self, X, y=None):
        ...
        dout,grads['W3'],grads['b3'] = affine_backward(dout,cache_list[cache_index])
        cache_index -= 1
        loss += 0.5*self.reg*np.sum(self.params['W3']**2)

        dout,grads['W2'],grads['b2'] = affine_relu_backward(dout,cache_list[cache_index])
        cache_index -= 1
        loss += 0.5*self.reg*np.sum(self.params['W2']**2)

        dout,grads['W1'],grads['b1'] = conv_relu_pool_backward(dout,cache_list[cache_index])
        cache_index -= 1
